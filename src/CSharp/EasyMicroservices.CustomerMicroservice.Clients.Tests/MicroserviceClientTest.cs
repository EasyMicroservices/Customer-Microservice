...
namespace EasyMicroservices.CustomerMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        public async Task GetAllTestTest()
        {
            ...
            //await OnInitialize();
            //var microserviceClient = new Customer.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
